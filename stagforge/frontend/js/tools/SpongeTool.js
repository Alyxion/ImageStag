...
export class SpongeTool extends Tool {
    ...
    /**
     * Sponge at document coordinates.
     */
    spongeAtDocCoords(layer, docX, docY) {
    ...
    /**
     * Legacy spongeAt for layer-local coordinates (used by API executeAction).
     */
    spongeAt(layer, x, y) {
    ...
    /**
     * Sponge along a line (document coordinates).
     */
    spongeLineAtDocCoords(layer, x1, y1, x2, y2) {
        ...
        for (let i = 0; i <= steps; i++) {
            ...
            const x = x1 + (x2 - x1) * t;
            const y = y1 + (y2 - y1) * t;
            this.spongeAtDocCoords(layer, x, y);
        }
    }

    /**
     * Legacy spongeLine for layer-local coordinates (used by API executeAction).
     */
